...
extension ColorsVC {
    ...
    func loadColors() {
        ...
        colors.append(Color(n: "Free-to-go green", c: UIColor(red:0.11, green:0.74, blue:0.36, alpha:1.0), b: .white))
        ...
        colors.append(Color(n: "Red orange", c: UIColor(red:0.88, green:0.35, blue:0.23, alpha:1.0), b: .white))
        colors.append(Color(n: "Carrot juice", c: UIColor(red:0.88, green:0.46, blue:0.23, alpha:1.0), b: .white))
        colors.append(Color(n: "Fresh orange", c: UIColor(red:1.00, green:0.69, blue:0.00, alpha:1.0), b: .white))
        colors.append(Color(n: "Ferrari orange", c: UIColor(red:1.00, green:0.30, blue:0.00, alpha:1.0), b: .white))
        colors.append(Color(n: "Wizard purple", c: UIColor(red:0.26, green:0.31, blue:1.00, alpha:1.0), b: .white))
        colors.append(Color(n: "Plum purple", c: UIColor(red:0.21, green:0.24, blue:0.61, alpha:1.0), b: .white))
